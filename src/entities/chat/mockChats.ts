...
<<<<<<< HEAD
			author: 'them',
			text:
				'Я могу искать ж/д, авиа, автобус, электрички, отели и мультимаршруты через Tutu MCP, а потом давать ссылку на оформление. Попробуйте спросить про билеты, пересадки или проживание.',
			time: 'сейчас',
=======
			author: 'me',
			content: { kind: 'text', text: 'Нужна помощь' },
		...
		},
		{
			id: '5',
			author: 'them',
			content: { kind: 'flightCard', flight: FLIGHT_THERE_1 },
			time: '12:00 сегодня',
		},
		{
			id: '6',
			author: 'them',
			content: { kind: 'flightCard', flight: FLIGHT_THERE_2 },
			time: '12:00 сегодня',
		},
		{
			id: '7',
		...
		},
		{
			id: '9',
			author: 'them',
			content: { kind: 'flightCard', flight: FLIGHT_BACK_1 },
			time: '12:00 сегодня',
		},
		{
			id: '9b',
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 220">
  <rect width="320" height="220" fill="#bbbbbb"/>
  <g fill="#9a9a9a">
    <rect x="0" y="30" width="80" height="80" opacity="0.55"/>
    <rect x="90" y="10" width="60" height="70" opacity="0.6"/>
    <rect x="160" y="40" width="70" height="90" opacity="0.5"/>
    <rect x="240" y="20" width="70" height="60" opacity="0.6"/>
    <rect x="20" y="130" width="90" height="80" opacity="0.55"/>
    <rect x="130" y="130" width="80" height="80" opacity="0.6"/>
    <rect x="220" y="110" width="90" height="100" opacity="0.5"/>
  </g>
  ...
  <g transform="translate(160 110) rotate(-20)">
    <g stroke="#ff7a00" stroke-width="4" fill="none">
      <circle cx="90" cy="-50" r="14" stroke-dasharray="2 2"/>
      <path d="M 80 -38 Q 30 -10 10 0" />
    </g>
    <g stroke="#a181ff" stroke-width="4" fill="none">
      <circle cx="-100" cy="50" r="14" stroke-dasharray="2 2"/>
    </g>
    <circle cx="90" cy="-50" r="18" fill="#ff7a00" opacity="0.55"/>
    <circle cx="90" cy="-50" r="10" fill="#ff7a00"/>
    <circle cx="-100" cy="50" r="18" fill="#a181ff" opacity="0.55"/>
    <circle cx="-100" cy="50" r="10" fill="#a181ff"/>
    <g transform="translate(0 -10) rotate(20)">
      <g fill="#ffffff" stroke="#e5e7eb" stroke-width="2">
        <path d="M -110 -10 L 80 -20 L 100 0 L 80 20 L -110 10 L -130 20 L -140 20 L -130 5 L -130 -5 L -140 -20 L -130 -20 Z"/>
        <path d="M -40 -20 L -30 -55 L -10 -50 L -20 -20 Z" fill="#c7c9cd"/>
        <path d="M -40 20 L -30 55 L -10 50 L -20 20 Z" fill="#c7c9cd"/>
        <circle cx="-70" cy="-5" r="6" fill="#a181ff"/>
        <circle cx="30" cy="-10" r="6" fill="#ff7a00"/>
      </g>
    </g>
  </g>
</svg>`),
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 180">
  <defs>
    <linearGradient id="tg" x1="0" y1="0" x2="1" y2="1">
      ...
      <stop offset="100%" stop-color="#d9ccff"/>
    </linearGradient>
  </defs>
  <g transform="translate(10 50) rotate(-8)">
    <path d="M 0 0 L 200 0 C 210 0 216 6 216 14 L 216 30 C 224 30 230 36 230 44 L 230 76 C 230 84 224 90 216 90 L 216 106 C 216 114 210 120 200 120 L 0 120 Z"
          fill="url(#tg)" stroke="#22c55e" stroke-width="8"/>
    <line x1="170" y1="0" x2="170" y2="120" stroke="#22c55e" stroke-width="2" stroke-dasharray="4 4"/>
    <path d="M 170 -6 a 6 6 0 0 0 0 12 Z" fill="#f1efe7"/>
    <path d="M 170 114 a 6 6 0 0 0 0 -12 Z" fill="#f1efe7"/>
    <rect x="14" y="16" width="140" height="26" rx="4" fill="#ffffff" stroke="#e2dfd7"/>
    <rect x="14" y="52" width="100" height="12" rx="3" fill="#e2dfd7"/>
    <rect x="14" y="70" width="140" height="16" rx="4" fill="#ffffff" stroke="#e2dfd7"/>
  </g>
  <g transform="translate(70 20) rotate(6)">
    <path d="M 0 0 L 200 0 C 210 0 216 6 216 14 L 216 30 C 224 30 230 36 230 44 L 230 76 C 230 84 224 90 216 90 L 216 106 C 216 114 210 120 200 120 L 0 120 Z"
          fill="url(#tg)" stroke="#a181ff" stroke-width="8"/>
    <line x1="170" y1="0" x2="170" y2="120" stroke="#a181ff" stroke-width="2" stroke-dasharray="4 4"/>
    <path d="M 170 -6 a 6 6 0 0 0 0 12 Z" fill="#f1efe7"/>
    <path d="M 170 114 a 6 6 0 0 0 0 -12 Z" fill="#f1efe7"/>
    <rect x="14" y="16" width="140" height="26" rx="4" fill="#ffffff" stroke="#e2dfd7"/>
    <rect x="14" y="52" width="100" height="12" rx="3" fill="#e2dfd7"/>
    <rect x="14" y="70" width="140" height="16" rx="4" fill="#ffffff" stroke="#e2dfd7"/>
		...
		},
		{
			...
			content: {
				kind: 'text',
				text: 'Поздравляем,при покупке любого билета вы автоматичесски учавствуете в розыгрыше и для вас доступна мини игра.Чтобы узнат подробности, нажмите на кнопку"мини игра"',
			},
			time: '12:00 сегодня',
		},
		{
