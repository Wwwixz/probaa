...
interface HeaderProps {
	/** На экране чатов иконки поиска нет — там своя строка поиска в контенте */
	showSearch?: boolean;
}

/**
 * Верхняя панель: настройки слева, поиск/камера/уведомления справа.
 * Каждая иконка — готовый круг 44×44 из Figma (сам круг уже "зашит" в
 * SVG, отдельно фон не рисуем).
 */
